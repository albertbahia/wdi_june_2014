...
describe Calculator do
  ...
  describe "#power" do
    ...
    it "raises one number to the power of another number" do
      expect(calculator.power(3, 0)).to eq(1)
    end
  end

  describe "#any_operand" do
    it "takes any number of arguments and performs the operand on it" do
      expect(calculator.any_operand(:**, 3, 3)).to eq(27)
    end

    it "takes any number of arguments and performs the operand on it" do
      expect(calculator.any_operand(:*, 2, 2, 2, 3)).to eq(24)
    end
  end
