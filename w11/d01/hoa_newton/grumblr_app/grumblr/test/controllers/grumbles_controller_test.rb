...
class GrumblesControllerTest < ActionController::TestCase
  ...
  test "should create grumble" do
    assert_difference('Grumble.count') do
      post :create, grumble: { author: @grumble.author, avatar: @grumble.avatar, content: @grumble.content, image: @grumble.image, title: @grumble.title }
    end
  ...
  test "should update grumble" do
    patch :update, id: @grumble, grumble: { author: @grumble.author, avatar: @grumble.avatar, content: @grumble.content, image: @grumble.image, title: @grumble.title }
    assert_redirected_to grumble_path(assigns(:grumble))
  end
