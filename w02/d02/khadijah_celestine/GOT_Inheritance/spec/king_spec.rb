...
describe King do
  ...
  describe '#introduce' do
    it 'introduces the king with name, house, and realm' do
      expect(ned.introduce).to include('Ned')
      expect(ned.introduce).to include('Stark')
      expect(ned.introduce).to include('North')
    end
    it 'includes the fact that it is a noble king' do
      expect(ned.introduce).to include('is a noble king')
    end
  end
