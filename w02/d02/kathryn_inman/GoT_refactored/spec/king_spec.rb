...
describe King do
  ...
  describe '#introduce' do
    it 'introduces the king with name, house, and realm' do
      expect(ned.introduce).to include("#{@name}")
      expect(ned.introduce).to include("#{@house}")
      expect(ned.introduce).to include("#{@realm}")
    end
    it 'includes the fact that it is an noble king' do
      expect(ned.introduce).to include("noble king")
    end
  end
